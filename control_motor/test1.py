...
class MotorController:
    ...
    def cmd_vel_callback(self, data):
        ...
        self.jog[0] = int(round((wheels[0] * 240 * 20) / (pi * 2 * self.WHEEL_RADIUS), 0))
        self.jog[1] = int(round((wheels[1] * 240 * 20) / (pi * 2 * self.WHEEL_RADIUS), 0))
        self.jog[2] = int(round((wheels[2] * 240 * 20) / (pi * 2 * self.WHEEL_RADIUS), 0))
